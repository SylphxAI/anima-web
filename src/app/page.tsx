      ...
      <nav>
        ...
        >
          ...
          >
            ...
            <a href="#contact" className="btn-primary" style={{ padding: "0.625rem 1.25rem", fontSize: "0.9rem" }}>
              Get in touch
            </a>
          </div>
        </div>
      ...
      <main>
        ...
        >
          ...
          >
            ...
            >
              Anima deploys autonomous agents into your business workflows.
              They communicate, take action, and improve — without you managing them.
            </p>
            ...
            >
              ...
              <svg viewBox="0 0 800 180" width="100%" height="180" style={{ opacity: 0.15 }}>
                <defs>
        ...
        <section id="features" style={{ background: "rgba(255,255,255,0.01)" }}>
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            <div className="reveal" style={{ textAlign: "center", marginBottom: "4rem" }}>
              <p style={{ color: "var(--accent-light)", fontWeight: 600, fontSize: "0.85rem", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "1rem" }}>
                Why Anima
              </p>
              <h2
                style={{
        ...
        {/* ─────────────────────────────── USE CASES ─────────────────────────────── */}
        <section id="use-cases" style={{ background: "rgba(99,102,241,0.02)", borderTop: "1px solid rgba(99,102,241,0.08)", borderBottom: "1px solid rgba(99,102,241,0.08)" }}>
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            <div className="reveal" style={{ textAlign: "center", marginBottom: "4rem" }}>
              <p style={{ color: "var(--accent-light)", fontWeight: 600, fontSize: "0.85rem", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "1rem" }}>
                Use cases
              ...
              <p style={{ color: "var(--muted)", fontSize: "1.1rem", maxWidth: "480px", margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p
                ...
                style={{ color: "var(--muted)", fontSize: "1.1rem", marginBottom: "2rem", lineHeight: 1.65 }}
              >
            ...
            >
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.375rem", marginBottom: "1rem" }}>
                  <span style={{ fontSize: "1.5rem", fontWeight: 700, letterSpacing: "-0.02em" }}>anima</span>
                  <span
                    style={{
                      width: "6px",
                      height: "6px",
                ...
                <p style={{ color: "var(--muted)", lineHeight: 1.65, fontSize: "0.95rem", maxWidth: "320px" }}>
              ...
              <div>
                ...
                <p style={{ color: "var(--muted)", lineHeight: 1.65, fontSize: "0.95rem", marginBottom: "1.25rem" }}>
