...
/**
 * Spiron instance registry
 * Each row = one running Spiron agent instance
 */
export const animaInstances = pgTable("anima_instances", {
	...
	internalUrl: text("internal_url"), // e.g. "http://spiron-stanley:3000"
	orgName: text("org_name"), // e.g. "Epiow Limited"
	/** Platform app ID if provisioned via Platform API */
	platformAppId: text("platform_app_id"),
	/** Public URL of the deployed instance, e.g. "https://spiron-alice.sylphx.app" */
